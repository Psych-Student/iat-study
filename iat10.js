	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			remindErrorText : '<p style="text-align:center; font-size:14px; font-family:Inter, system-ui, sans-serif; color:#64748b;">' +
			'If you make a mistake, a red <span style="color:#ef4444; font-weight:600;">X</span> will appear. ' +
			'Press the other key to continue.</p>',

			remindErrorTextTouch : '<p style="text-align:center; font-size:16px; font-family:Inter, system-ui, sans-serif; color:#64748b;">' +
			'If you make a mistake, a red <span style="color:#ef4444; font-weight:600;">X</span> will appear. ' +
...
leftKeyText : 'Press E for',
			...
			keysCss : {'font-size':'0.9em', 'font-family':'Inter, system-ui, sans-serif', color:'#64748b', 'font-weight':'500'},
			//Text and style for the separator between the top and bottom category labels.
			orText : 'or',
			orCss : {'font-size':'1.4em', color:'#94a3b8', 'font-weight':'400'},
			...
			instAttributePractice: '<div style="font-family: Inter, system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">' +
			...
			instCategoriesPractice: '<div style="font-family: Inter, system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">' +
				'<p style="text-align:center; color:#64748b; font-size:14px; margin-bottom:24px; font-weight:500;">Part blockNum of nBlocks</p>' +
				'<div style="background:#f8fafc; border-radius:12px; padding:24px; margin-bottom:20px;">' +
				'<p style="font-size:16px; color:#1e293b; line-height:1.6; margin:0 0 16px 0;">' +
...
instFirstCombined : '<div style="font-family: Inter, system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">' +
				'<p style="text-align:center; color:#64748b; font-size:14px; margin-bottom:24px; font-weight:500;">Part blockNum of nBlocks</p>' +
				'<div style="background:#f8fafc; border-radius:12px; padding:24px; margin-bottom:20px;">' +
			...
			instSecondCombined : '<div style="font-family: Inter, system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">' +
				'<p style="text-align:center; color:#64748b; font-size:14px; margin-bottom:24px; font-weight:500;">Part blockNum of nBlocks</p>' +
				'<div style="background:#f8fafc; border-radius:12px; padding:24px; margin-bottom:20px;">' +
			...
			instSwitchCategories : '<div style="font-family: Inter, system-ui, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">' +
				'<p style="text-align:center; color:#64748b; font-size:14px; margin-bottom:24px; font-weight:500;">Part blockNum of nBlocks</p>' +
				'<div style="background:#fef3c7; border-radius:12px; padding:16px 24px; margin-bottom:20px; border-left:4px solid #f59e0b;">' +
				'<p style="font-size:16px; color:#92400e; font-weight:600; margin:0;">⚠️ Watch out! The labels have switched sides.</p>' +
				'</div>' +
				'<div style="background:#f8fafc; border-radius:12px; padding:24px; margin-bottom:20px;">' +
				'<p style="font-size:16px; color:#1e293b; line-height:1.6; margin:0 0 16px 0;">' +
				'Press <span style="background:#1e293b; color:white; padding:4px 12px; border-radius:6px; font-weight:600; font-family:monospace;">E</span> for <span style="background:#16a34a; color:white; padding:4px 12px; border-radius:6px; font-weight:500;">leftCategory</span></p>' +
